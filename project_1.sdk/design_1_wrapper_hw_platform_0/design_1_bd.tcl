...
proc create_root_design { parentCell } {
  ...
  set myip_0 [ create_bd_cell -type ip -vlnv Mechyd.ad:user:myip:1.0 myip_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  create_bd_addr_seg -range 0x1000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_0/S00_AXI/S00_AXI_reg] SEG_myip_0_S00_AXI_reg
